...
public class HystrixCommandAspect {
    ...
    private final Logger logger = LoggerFactory.getLogger(HystrixCommandAspect.class);
    ...
    static {
        META_HOLDER_FACTORY_MAP = ImmutableMap.<HystrixCommandAspect.HystrixPointcutType, HystrixCommandAspect.MetaHolderFactory>builder()
    ...
    public Object methodsAnnotatedWithHystrixCommand(final ProceedingJoinPoint joinPoint) throws Throwable {
        boolean hystrixState = PropertyPlaceholder.getBoolean("hystrix_state"); //表示熔断打开
        if (!hystrixState) {
            logger.info("熔断开关已关闭");
            ...
            HystrixCommandAspect.MetaHolderFactory metaHolderFactory = META_HOLDER_FACTORY_MAP.get(HystrixCommandAspect.HystrixPointcutType.of(method));
    ...
    /**
     * A factory to create MetaHolder depending on {@link HystrixCommandAspect.HystrixPointcutType}.
     */
    ...
    private static class CollapserMetaHolderFactory extends HystrixCommandAspect.MetaHolderFactory {
    ...
    private static class CommandMetaHolderFactory extends HystrixCommandAspect.MetaHolderFactory {
        @Override
    ...
    private enum HystrixPointcutType {
        ...
        static HystrixCommandAspect.HystrixPointcutType of(Method method) {
